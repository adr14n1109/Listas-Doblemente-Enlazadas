 ...
 *
 *  Estructura elegida: Listas Doblemente Enlazadas
 *  Laboratorio de origen : (02)
 *
 *  Por que esta estructura y no otra?
 *  Elegi las listas dobles porque son las más adecuadas para poder enganchar y desenganchar cada vagon.
 *  Puedo tener los vagones conectados en cabeza y cola, como tambien puedo avanzar y retroceder entre ellos.
 *  En las listas dobles tambien tengo la opción de poder añadir y eliminar head/tail.
 *  -
 *  -
 *
 * ===================================================================== */
